...
telle quelle) dans le template hit_combo_viewer.html. Meme pattern que
r6_directional_punch/scripts/build_viewer.py.
"""
import base64
import glob
import json
...
TEMPLATE = os.path.join(SCRIPT_DIR, "hit_combo_viewer.html")
THREE_JS = os.path.join(SCRIPT_DIR, "vendor", "three.min.js")
SCENE_JSON = "/tmp/hit_combo_scene_data.json"


def main():
    out_path = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
        SCRIPT_DIR, "..", "output", "hit_combo_viewer_final.html")
