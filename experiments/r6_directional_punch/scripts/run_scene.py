"""
Construit et exporte les deux KeyframeSequence de la scene (attaquant +
...
from choreography import (attacker_punch, dummy_reaction,
...
def main():
    ...
    _export(attacker_punch, ATTACKER_SECONDARY_MOTION,
             "character_attacker_punch.rbxmx", "R6_DirectionalPunch")
    _export(dummy_reaction, DUMMY_SECONDARY_MOTION,
             "character_dummy_reaction.rbxmx", "R6_HitReaction")
