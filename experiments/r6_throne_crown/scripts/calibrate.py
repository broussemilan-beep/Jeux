...
if __name__ == "__main__":
    ...
    preuves.executer_et_enregistrer(
        "r6_throne_crown", "mesure_technique", "scene",
        [os.path.join(_ici, f) for f in ('calibrate.py', 'choreography.py', 'anim_engine.py', 'r6_rig.py', 'props.py')],
        main, "cd experiments/r6_throne_crown/scripts && python3 calibrate.py")
