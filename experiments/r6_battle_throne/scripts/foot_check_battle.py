...
if __name__ == "__main__":
    ...
    preuves.executer_et_enregistrer(
        ...
        [os.path.join(_ici, f) for f in ('foot_check_battle.py', 'choreography.py', 'anim_engine.py', 'r6_rig.py')],
        main, "cd experiments/r6_battle_throne/scripts && python3 foot_check_battle.py")
