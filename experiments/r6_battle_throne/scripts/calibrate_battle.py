...
if __name__ == "__main__":
    ...
    preuves.executer_et_enregistrer(
        "r6_battle_throne", "mesure_technique", "scene",
        [os.path.join(_ici, f) for f in ('calibrate_battle.py', 'choreography.py', 'anim_engine.py', 'r6_rig.py', 'punch_combo.py')],
        main, "cd experiments/r6_battle_throne/scripts && python3 calibrate_battle.py")
