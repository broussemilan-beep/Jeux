...
if __name__ == "__main__":
    ...
    preuves.executer_et_enregistrer(
        "r6_black_hole", "mesure_technique", "scene",
        [os.path.join(_ici, f) for f in ('calibrate.py', 'choreography.py', 'anim_engine.py', 'r6_rig.py', 'pipeline.py', 'black_hole_track.py')],
        main, "cd experiments/r6_black_hole/scripts && python3 calibrate.py")
