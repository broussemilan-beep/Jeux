...
"stone_ground", "ruin_wall", copiees depuis r6_solar_smite) et THREE_JS
(bibliotheque vendorisee, voir vendor/three.min.js) dans le template
black_hole_viewer.html. Meme pattern que r6_solar_smite/build_viewer.py.
"""
import base64
import glob
import json
...
TEMPLATE = os.path.join(SCRIPT_DIR, "black_hole_viewer.html")
THREE_JS = os.path.join(SCRIPT_DIR, "vendor", "three.min.js")
SCENE_JSON = "/tmp/black_hole_scene_data.json"


def main():
    out_path = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
        SCRIPT_DIR, "..", "output", "black_hole_viewer_final.html")
