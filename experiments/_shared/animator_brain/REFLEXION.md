...
- **tenue_avant_choc** : Le mouvement freine juste AVANT le choc, puis explose juste apres (le flash cache le saut de pose). C'est l'inverse d'un hitstop qui gele apres. (sources : IMPACT HAVEN (mesure); coup chapeau LeftRight2601 (mesure); Milan v1 : manque de puissance (piste); fiches des refs (2026-09-24) : 3 refs sur 9 avec cartes d'impact le montrent (coup chapeau, serious punch 2, IMPACT HAVEN) ; Black Flash, Rewind Clock, Serious Punch TSB non -> depend du style, pas universel)
...
## Echelle calibree sur 3 notes : note = 6.63 + 0.62 x score
...
- tenue_avant_choc     poids_note 0.64 (confiance principe 0.40)
