...
- **fluidite** : Le mouvement enchaine : un membre ne s'arrete pas a chaque pose cle (chevauchement, suivi), il repart avant d'etre a l'arret. (sources : 12 principes de l'animation (follow-through, overlapping action); perception 2026-09-24 : M1 pro 4,2-5,7 traits/s ; notre aerien (aime par Milan) 3,5-4,2 ; notre rafale 8,8-11,9 (comme une reaction a un coup); auto-critique : cles IK avec ralenti a chaque cle -> arret a chaque cle; synthese 2026-09-24 : temps fige (images immobiles >= 150 ms) sakuga 2 % [1-5], refs de Milan 14 %, nos versions 37 %; synthese finale 2026-09-24 : temps fige sakuga (plans de combat TV) 2 %, danbooru (animations de fans, boucles) 22 %, refs de Milan 14 %, nous 37 % -- au-dessus de tout)
