...
|---|---|---|
| 0 | **Milan** envoie `Blender R6 Rig.blend` et `Studio R6 Rig.rbxm` (V2.22) | hashes identiques à ceux publiés |
...
| 2 | Outil de revue de pose (face, profil, caméra de jeu ; faces F/B/L/R), puis branchement du V2.22 | planches de revue committées |
