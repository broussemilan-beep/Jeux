...
spec = {
 ...
 "x0": json.load(open("fit_460_x0.json")) if len(sys.argv) > 1 else [5.7, 6.5, 4.25, 215, 19, -5, 22, 27, -68, -28],
 "step": [0.5, 3, 0.3, 15, 10, 10, 20, 15, 20, 15],
 "prior": [(5.5, 3), (7, 20), (4, 2), (205, 90), (10, 40), (0, 40), (0, 120), (0, 90), (0, 120), (0, 90)],
 "marks": {"RA_tip": ((242, 298), 1), "LA_tip": ((568, 345), 1),
           "T_bas_D_av": ((339, 383), 0.5), "Tete": ((445, 200), 0.2)},
...
json.dump({"pose": pose, "cam": cam}, open("fit_460b.json", "w"))
json.dump(list(best[0]), open("fit_460b_x.json", "w"))
