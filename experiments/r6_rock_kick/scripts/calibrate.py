...
if __name__ == "__main__":
    ...
    preuves.executer_et_enregistrer(
        "r6_rock_kick", "mesure_technique", "scene",
        [os.path.join(_ici, f) for f in ('calibrate.py', 'choreography.py', 'anim_engine.py', 'r6_rig.py', 'rock_track.py')],
        main, "cd experiments/r6_rock_kick/scripts && python3 calibrate.py")
